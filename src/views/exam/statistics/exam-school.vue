...
import { getExamSchoolPass, getExamSchool } from "@/api/index";
...
const {
  ...
  examReasons,
  carTypeList
} = useTableSeach(getExamSchoolPass, renderEcharts);
    ...
    <div class="w-100% flex-1 flex flex-col justify-between">
      <div class="w-100% table-container mt-20px">
        <el-table :data="tableData" border style="width: 100%">
          ...
          <el-table-column prop="total" label="考生人数" />
          <el-table-column prop="success" label="合格人数" />
          <el-table-column prop="fail" label="不合格人数" />
          <el-table-column prop="missingNum" label="缺考人数" />
