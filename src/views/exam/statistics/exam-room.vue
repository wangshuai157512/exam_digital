...
import { getExamRoom, getExaminer } from "@/api/index";
...
const {
  ...
  examReasons,
  carTypeList
} = useTableSeach(getExamRoom, renderEcharts);
    ...
    <div class="w-100% flex-1 flex flex-col justify-between">
      <div class="w-100% table-container mt-20px">
        <el-table :data="tableData" border style="width: 100%">
          ...
          <el-table-column prop="examPersonNum" label="考生人数" />
          <el-table-column prop="successNum" label="合格人数" />
